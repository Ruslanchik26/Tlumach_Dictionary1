...
public class History extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.m_seach) {
            ...
            Intent intent = new Intent(History.this, Add.class);
            startActivities(new Intent[]{intent});
        } else if (id == R.id.m_help) {
            Intent intent = new Intent(History.this, Help.class);
            startActivities(new Intent[]{intent});
        } else if (id == R.id.m_about_aplication) {
            Intent intent = new Intent(History.this, About_aplication.class);
            startActivities(new Intent[]{intent});
        }
        else if (id == R.id.m_enter) {
            Intent intent = new Intent(History.this, Enter.class);
            startActivities(new Intent[]{intent});
        }
